...
public class DoubleCompareRatherThanEqualityRefactoring extends AbstractRefactoringRule {
    /**
     * Get the name.
     *
     * @return the name.
    ...
    private void replace(final InfixExpression node) {
        ...
        this.ctx.getRefactorings().replace(node,
                b.infixExpr(b.invoke("Double", "compare",
                        b.copy(node.getLeftOperand()), b.copy(node.getRightOperand())),
                        node.getOperator(),
                        b.number("0")));
    }
}
