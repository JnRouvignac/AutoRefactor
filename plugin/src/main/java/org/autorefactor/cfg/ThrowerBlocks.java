...
class ThrowerBlocks {
    private final Map<CFGBasicBlock, Set<ITypeBinding>> potentialThrowingBlocks= new HashMap<CFGBasicBlock, Set<ITypeBinding>>();
    private final Map<CFGEdgeBuilder, Set<ITypeBinding>> potentialThrowingEdges= new HashMap<CFGEdgeBuilder, Set<ITypeBinding>>();
