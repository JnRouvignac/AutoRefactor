...
public class ObsoleteUnboxingRatherThanExplicitMethodCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteUnboxingRatherThanExplicitMethodCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteUnboxingRatherThanExplicitMethodCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteUnboxingRatherThanExplicitMethodCleanUp_reason;
	}
	...
	private void useUnboxing(final MethodInvocation node) {
		...
		TextEditGroup group= new TextEditGroup(MultiFixMessages.ObsoleteUnboxingRatherThanExplicitMethodCleanUp_description);
