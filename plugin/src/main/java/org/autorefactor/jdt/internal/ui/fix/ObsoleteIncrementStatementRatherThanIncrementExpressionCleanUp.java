...
public class ObsoleteIncrementStatementRatherThanIncrementExpressionCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteIncrementStatementRatherThanIncrementExpressionCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteIncrementStatementRatherThanIncrementExpressionCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteIncrementStatementRatherThanIncrementExpressionCleanUp_reason;
	}
	...
	private final class ExpressionVisitor extends BlockSubVisitor {
		...
		private void extractIncrement(final Expression visited, final Expression variable,
			...
			TextEditGroup group= new TextEditGroup(MultiFixMessages.ObsoleteIncrementStatementRatherThanIncrementExpressionCleanUp_description);
