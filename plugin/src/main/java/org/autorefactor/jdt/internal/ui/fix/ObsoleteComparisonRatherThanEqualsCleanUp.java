...
public class ObsoleteComparisonRatherThanEqualsCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteComparisonRatherThanEqualsCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteComparisonRatherThanEqualsCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteComparisonRatherThanEqualsCleanUp_reason;
	}
