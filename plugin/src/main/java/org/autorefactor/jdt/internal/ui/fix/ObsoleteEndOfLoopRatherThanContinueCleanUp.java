...
public class ObsoleteEndOfLoopRatherThanContinueCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteEndOfLoopRatherThanContinueCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteEndOfLoopRatherThanContinueCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteEndOfLoopRatherThanContinueCleanUp_reason;
	}
	...
	private final class ContinueInBlockVisitor extends BlockSubVisitor {
		...
		public boolean visit(final ContinueStatement node) {
			if (result
				...
				TextEditGroup group= new TextEditGroup(MultiFixMessages.ObsoleteEndOfLoopRatherThanContinueCleanUp_description);
