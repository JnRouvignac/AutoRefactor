...
public class ObsoleteValueOfRatherThanInstantiationCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteValueOfRatherThanInstantiationCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteValueOfRatherThanInstantiationCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteValueOfRatherThanInstantiationCleanUp_reason;
	}
