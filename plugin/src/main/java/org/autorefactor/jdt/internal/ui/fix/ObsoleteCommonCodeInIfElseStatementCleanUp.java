...
public class ObsoleteCommonCodeInIfElseStatementCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteCommonCodeInIfElseStatementCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteCommonCodeInIfElseStatementCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteCommonCodeInIfElseStatementCleanUp_reason;
	}
	...
	public boolean visit(final IfStatement visited) {
		...
		if (collectAllCases(allCasesStatements, visited, allCases)) {
			...
			for (int i= 0; i < allCasesStatements.size(); i++) {
				caseStmtsToRemove[i]= new LinkedList<>();
			}
			...
			int minSize= minSize(allCasesStatements, casesToRefactor);
	...
	private int minSize(final List<List<Statement>> allCasesStatements, List<Integer> casesToRefactor) {
