...
public class ObsoleteStringRatherThanNewStringCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteStringRatherThanNewStringCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteStringRatherThanNewStringCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteStringRatherThanNewStringCleanUp_reason;
	}
