...
public class ObsoleteSwitchCleanUp extends AbstractCleanUpRule {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteSwitchCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteSwitchCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteSwitchCleanUp_reason;
	}
