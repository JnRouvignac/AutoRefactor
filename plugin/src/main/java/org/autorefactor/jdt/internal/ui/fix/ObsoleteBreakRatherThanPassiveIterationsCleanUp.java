...
public class ObsoleteBreakRatherThanPassiveIterationsCleanUp extends AbstractCleanUpRule {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteBreakRatherThanPassiveIterationsCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteBreakRatherThanPassiveIterationsCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteBreakRatherThanPassiveIterationsCleanUp_reason;
	}
