...
public class ObsoleteTernaryOperatorRatherThanDuplicateConditionsCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteTernaryOperatorRatherThanDuplicateConditionsCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteTernaryOperatorRatherThanDuplicateConditionsCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteTernaryOperatorRatherThanDuplicateConditionsCleanUp_reason;
	}
