...
public class ObsoleteEqualsNullableCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteEqualsNullableCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteEqualsNullableCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteEqualsNullableCleanUp_reason;
	}
