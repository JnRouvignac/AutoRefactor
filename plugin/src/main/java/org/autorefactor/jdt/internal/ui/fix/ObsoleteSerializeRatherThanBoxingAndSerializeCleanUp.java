...
public class ObsoleteSerializeRatherThanBoxingAndSerializeCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteSerializeRatherThanBoxingAndSerializeCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteSerializeRatherThanBoxingAndSerializeCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteSerializeRatherThanBoxingAndSerializeCleanUp_reason;
	}
