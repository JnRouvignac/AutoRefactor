...
public class ObsoleteReduceIndentationCleanUp extends AbstractCleanUpRule {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteReduceIndentationCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteReduceIndentationCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteReduceIndentationCleanUp_reason;
	}
