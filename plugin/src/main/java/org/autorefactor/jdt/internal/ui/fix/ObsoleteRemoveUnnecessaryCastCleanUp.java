 ...
 */
public class ObsoleteRemoveUnnecessaryCastCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteRemoveUnnecessaryCastCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteRemoveUnnecessaryCastCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteRemoveUnnecessaryCastCleanUp_reason;
	}
