...
public class ObsoleteGenericListRatherThanRawListCleanUp extends AbstractClassSubstituteCleanUp {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteGenericListRatherThanRawListCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteGenericListRatherThanRawListCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteGenericListRatherThanRawListCleanUp_reason;
	}
