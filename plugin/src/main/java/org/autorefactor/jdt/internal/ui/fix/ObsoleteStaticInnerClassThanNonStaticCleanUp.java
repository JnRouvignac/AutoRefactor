...
public class ObsoleteStaticInnerClassThanNonStaticCleanUp extends AbstractCleanUpRule {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteStaticInnerClassThanNonStaticCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteStaticInnerClassThanNonStaticCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteStaticInnerClassThanNonStaticCleanUp_reason;
	}
