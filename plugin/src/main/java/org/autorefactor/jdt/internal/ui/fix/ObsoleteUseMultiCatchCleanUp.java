...
public class ObsoleteUseMultiCatchCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteUseMultiCatchCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteUseMultiCatchCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteUseMultiCatchCleanUp_reason;
	}
