...
public class ObsoleteParsingRatherThanValueOfCleanUp extends AbstractCleanUpRule {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteParsingRatherThanValueOfCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteParsingRatherThanValueOfCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteParsingRatherThanValueOfCleanUp_reason;
	}
