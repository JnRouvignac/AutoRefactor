...
public class ObsoleteOperandFactorizationCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteOperandFactorizationCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteOperandFactorizationCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteOperandFactorizationCleanUp_reason;
	}
