...
public class InstanceofRatherThanIsInstanceCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.InstanceofRatherThanIsInstanceCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.InstanceofRatherThanIsInstanceCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.InstanceofRatherThanIsInstanceCleanUp_reason;
	}
