...
public final class AllCleanUpRules {
	...
	public static List<RefactoringRule> getAllCleanUpRules() {
		return newArrayList(new ObsoleteAddBracketsToControlStatementCleanUp(),
				...
				new ObsoleteIntPrimitiveRatherThanWrapperCleanUp(), new ShortPrimitiveRatherThanWrapperCleanUp(),
				new ObsoleteLongPrimitiveRatherThanWrapperCleanUp(), new DoublePrimitiveRatherThanWrapperCleanUp(),
