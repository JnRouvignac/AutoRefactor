...
public final class AllCleanUpRules {
	...
	public static List<RefactoringRule> getAllCleanUpRules() {
		return newArrayList(new ObsoleteAddBracketsToControlStatementCleanUp(),
				new ObsoleteRemoveSemiColonCleanUp(), new ObsoleteRemoveUnnecessaryLocalBeforeReturnCleanUp(),
				...
				new ObsoleteRedundantTruthCleanUp(),
				new RedundantBooleanCleanUp(),
				new ObsoleteEqualsNullableCleanUp(),
				new ObsoleteLocalVariableRatherThanFieldCleanUp(),
				new ObsoleteIntPrimitiveRatherThanWrapperCleanUp(), new ObsoleteShortPrimitiveRatherThanWrapperCleanUp(),
				new ObsoleteLongPrimitiveRatherThanWrapperCleanUp(), new ObsoleteDoublePrimitiveRatherThanWrapperCleanUp(),
				new ObsoleteFloatPrimitiveRatherThanWrapperCleanUp(), new ObsoleteCharPrimitiveRatherThanWrapperCleanUp(),
				new ObsoleteBytePrimitiveRatherThanWrapperCleanUp(), new ObsoleteAssignRatherThanFilterThenAssignAnywayCleanUp(),
				...
				new ObsoleteBooleanPrimitiveRatherThanWrapperCleanUp(), new ObsoleteLazyLogicalRatherThanEagerCleanUp(),
				...
				new ObsoleteCharacterParameterRatherThanStringCleanUp(),
				...
				new UpdateSetRatherThanTestingFirstCleanUp(), new IsEmptyRatherThanSizeCleanUp(), new MatchingStreamRatherThanCountCleanUp(),
				new ObsoleteMapCleanUp(),
