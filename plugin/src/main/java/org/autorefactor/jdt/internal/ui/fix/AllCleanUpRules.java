...
public final class AllCleanUpRules {
	...
	public static List<RefactoringRule> getAllCleanUpRules() {
		return newArrayList(new AddBracketsToControlStatementCleanUp(),
				new RemoveSemiColonCleanUp(), new RemoveUnnecessaryLocalBeforeReturnCleanUp(),
				...
				new VectorOldToNewAPICleanUp(), new ParsingRatherThanValueOfCleanUp(),
				new ValueOfRatherThanInstantiationCleanUp(),
				...
				new RedundantComparatorCleanUp(),
				...
				new InstanceofRatherThanIsInstanceCleanUp(),
				new StringRatherThanNewStringCleanUp(),
				new StringCleanUp(), new StringValueOfRatherThanConcatCleanUp(),
				...
				new AndConditionRatherThanEmbededIfCleanUp(),
				new DuplicateAlternativeCleanUp(),
