...
public class ObsoleteDuplicateAlternativeCleanUp extends AbstractCleanUpRule {
	@Override
	public String getName() {
		return MultiFixMessages.ObsoleteDuplicateAlternativeCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteDuplicateAlternativeCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteDuplicateAlternativeCleanUp_reason;
	}
