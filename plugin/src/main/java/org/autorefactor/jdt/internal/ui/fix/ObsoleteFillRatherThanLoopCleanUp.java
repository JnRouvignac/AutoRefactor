...
public class ObsoleteFillRatherThanLoopCleanUp extends NewClassImportCleanUp {
	...
	public String getName() {
		return MultiFixMessages.ObsoleteFillRatherThanLoopCleanUp_name;
	}

	@Override
	public String getDescription() {
		return MultiFixMessages.ObsoleteFillRatherThanLoopCleanUp_description;
	}

	@Override
	public String getReason() {
		return MultiFixMessages.ObsoleteFillRatherThanLoopCleanUp_reason;
	}
