...
public class ObsoleteSimpleNameRatherThanQualifiedNameSample {
    ...
    public int removeQualifiedNameForNonConflictingLocalMethodSimpleName() {
        // Keep this comment
        return ObsoleteSimpleNameRatherThanQualifiedNameSample.emptyMap();
    }
    ...
    public Integer removeQualifiedNameForNonConflictingLocalType() {
        // Keep this comment
        return new ObsoleteSimpleNameRatherThanQualifiedNameSample.Integer();
    }
    ...
    public String removeQualifiedNameForNonConflictingLocalField() {
        // Keep this comment
        return ObsoleteSimpleNameRatherThanQualifiedNameSample.DAY_OF_WEEK_IN_MONTH;
    }
    ...
    static class D extends C {
        ...
        public void replaceThisTopLevelPrivateConstant() {
            System.out.println("value is " + ObsoleteSimpleNameRatherThanQualifiedNameSample.TOP_LEVEL_PRIVATE_CONSTANT);
        }
    ...
    public void doNotConflictClassFieldAndLocalVariable(long classField) {
        ObsoleteSimpleNameRatherThanQualifiedNameSample.classField = classField;
    }

    static String property;
    static void setProperty(String property) {
        ObsoleteSimpleNameRatherThanQualifiedNameSample.property = property;
    }
...
class Outer {
    ...
    void doNotRefactorTopLevelClassCall() {
        ObsoleteSimpleNameRatherThanQualifiedNameSample.setProperty("hi");
    }
