 ...
 *
 * Copyright (C) 2016 Zsombor Gegesy - test case for a bug
 *
...
public class LocalEliminationSample {
    InnerService service;

    public String doNotEliminateEverything(String param) {
        param = (String) service.transform(param);
        return param;
    }

    public Object otherMethodCall(String param) {
        param = service.transform(param);
        return param;
    }
