...
public class SetRatherThanListSample {
    ...
    public void replaceArrayListInstanceCreation() {
        ...
        boolean isBarContained = new ArrayList<String>(new java.util.ArrayList<String>()).contains("bar");
    }
    ...
    public void replaceRawArrayList() {
        // Keep this comment
        boolean isFooContained = new ArrayList().contains("foo");
        // Keep this comment too
        boolean isBarContained = new ArrayList(new java.util.ArrayList<String>()).contains("bar");
    }
    ...
    public void replaceFullyQualifiedArrayList() {
        ...
        // Keep this comment too
        boolean isBarContained = new java.util.ArrayList(10).contains("bar");
    }
