...
public class SetRatherThanListSample {
    ...
    public boolean replaceArrayListWithLoop(List<Date> dates) {
        // Keep this comment
        java.util.HashSet<Date> collection = new java.util.HashSet<Date>();
        for (Date date : dates) {
            collection.add(date);
        }
    ...
    public boolean replaceArrayListWithModifier() {
        // Keep this comment
        final java.util.HashSet<Integer> collection = new java.util.HashSet<Integer>();
        collection.add(1);
    ...
    public boolean replaceReassignedArrayList() {
        ...
        // Keep this comment too
        java.util.HashSet<String> collection2 = collection1;
        collection2.add("BAR");
