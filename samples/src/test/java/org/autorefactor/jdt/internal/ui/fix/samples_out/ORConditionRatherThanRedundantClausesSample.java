...
public class ORConditionRatherThanRedundantClausesSample {
	...
	public void removeDuplicateConditionsWithEagerOperator(boolean redundantCondition, boolean condition) {
		// Keep this comment
		boolean newBoolean1 = redundantCondition | condition;
		boolean newBoolean2 = !redundantCondition | !condition;
		boolean newBoolean3 = condition | !redundantCondition;
		boolean newBoolean4 = !condition | redundantCondition;
		boolean newBoolean5 = redundantCondition | condition;
		boolean newBoolean6 = !redundantCondition | !condition;
		boolean newBoolean7 = condition | !redundantCondition;
		boolean newBoolean8 = !condition | redundantCondition;
	}
	...
	public void removeDuplicateConditionsInLargerExpressions(boolean redundantCondition, boolean condition, List<String> lastList) {
		// Keep this comment
		boolean newBoolean1 = redundantCondition || condition || lastList.remove("lorem");
		boolean newBoolean2 = redundantCondition || !condition || lastList.remove("lorem");
		boolean newBoolean3 = condition || !redundantCondition || lastList.remove("lorem");
		boolean newBoolean4 = !condition || redundantCondition || lastList.remove("lorem");
	}
	...
	public void removeDuplicateConditionsWithOtherExpressionFirst(boolean redundantCondition, boolean condition, List<String> firstList) {
		// Keep this comment
		boolean newBoolean1 = firstList.remove("lorem") || redundantCondition || condition;
		boolean newBoolean2 = firstList.remove("lorem") || redundantCondition || !condition;
	...
	public void removeDuplicateConditionsAmongOtherExpressions(boolean redundantCondition, boolean condition, List<String> myList) {
		...
		boolean newBoolean2 = redundantCondition || myList.remove("lorem") && !condition;
		boolean newBoolean3 = myList.remove("lorem") && condition || !redundantCondition;
		boolean newBoolean4 = myList.remove("lorem") && !condition || redundantCondition;
	}
	...
	public void removeDuplicateConditionsAmongOtherPassiveExpressions(boolean redundantCondition, boolean condition, boolean otherCondition) {
		// Keep this comment
		boolean newBoolean1 = redundantCondition || condition && otherCondition;
		boolean newBoolean2 = redundantCondition || !condition && otherCondition;
		boolean newBoolean3 = condition && otherCondition || !redundantCondition;
		boolean newBoolean4 = !condition && otherCondition || redundantCondition;
	}
